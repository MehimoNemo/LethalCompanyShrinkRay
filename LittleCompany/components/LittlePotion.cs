...
namespace LittleCompany.components
{
    ...
    public class LittleShrinkingPotion : LittlePotion
    {
        ...
        internal static int StorePriceConfig = Plugin.Config.SHRINK_POTION_STORE_PRICE;
        internal static int RarityConfig = Plugin.Config.SHRINK_POTION_SCRAP_RARITY;
    ...
    public class LittleEnlargingPotion : LittlePotion
    {
        ...
        internal static int StorePriceConfig = Plugin.Config.ENLARGE_POTION_STORE_PRICE;
        internal static int RarityConfig = Plugin.Config.ENLARGE_POTION_SCRAP_RARITY;

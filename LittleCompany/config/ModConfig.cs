...
namespace LittleCompany.Config
{
    public sealed class ModConfig
    {
        ...
        public void Setup()
        {
            ...
            values.maximumPlayerSize            = Plugin.BepInExConfig().Bind("General", "MaximumPlayerSize", 1.7f, new ConfigDescription("Defines, how tall a player can become (1.8 is the last fitting height for the ship inside!)", new AcceptableValueRange<float>(1f, 10f))).Value;
            ...
            values.sellablePlayers              = Plugin.BepInExConfig().Bind("Interactions", "sellablePlayers", true, "If true, held players can sell other players").Value;
